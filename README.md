...
To sync Rsvim specific API declarations (e.g. `@types/rsvim`), please clone [rsvim](https://github.com/rsvim/rsvim) repo in the sibling directory under the same parent directory as _this_ repo, then run `./sync.py`.
